// ______________________Скрипт обработки кнопки бургер-меню______________________
...
// ______________________Скрипт панели даты и времени______________________
function clock() {
  var d = new Date();
